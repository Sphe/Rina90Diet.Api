...
namespace Rina90Diet.Service.PersistenceService
{
    ...
    {
        private readonly IRina90DietDbFullDomainRepository<Genericattribute> _attributeRepository;
        private readonly IRina90DietDbFullDomainRepository<Genericattributevalue> _attributeValueRepository;
        private readonly IRina90DietDbFullDomainRepository<Genericattributetype> _attributeTypeRepository;
        private readonly IRina90DietDbFullDomainUnitOfWork _unitOfWork;
        private readonly IRina90DietBulkOperator _Rina90DietBulkOperator;

        private readonly ILogger<AttributeService> _logger;

        public AttributeService(ILogger<AttributeService> logger, 
            IRina90DietDbFullDomainRepository<Genericattribute> attributeRepository,
            IRina90DietDbFullDomainRepository<Genericattributevalue> attributeValueRepository,
            IRina90DietDbFullDomainRepository<Genericattributetype> attributeTypeRepository,
            IRina90DietDbFullDomainUnitOfWork unitOfWork,
            IRina90DietBulkOperator Rina90DietBulkOperator)
        {
            _logger = logger;
            ...
            _Rina90DietBulkOperator = Rina90DietBulkOperator;
        }
        ...
        public async Task<Tuple<string, IList<Genericattribute>>> CreateAttributeBulk(IList<AttributeBulk> attributesCreates)
        {
            ...
            var attributeTypeRepositoryLocal = (IRina90DietDbFullDomainRepository<Genericattributetype>)ServiceLocatorSingleton.Instance.ServiceProvider.GetService(typeof(IRina90DietDbFullDomainRepository<Genericattributetype>));
            var maxGaType = attributeTypeRepositoryLocal.DbSet.Max(x => x.Genericattributetypeid);
            var attributeValueRepositoryLocal = (IRina90DietDbFullDomainRepository<Genericattributevalue>)ServiceLocatorSingleton.Instance.ServiceProvider.GetService(typeof(IRina90DietDbFullDomainRepository<Genericattributevalue>));
            ...
            var Rina90DietBulkOperatorLocal1 = (IRina90DietBulkOperator)ServiceLocatorSingleton.Instance.ServiceProvider.GetService(typeof(IRina90DietBulkOperator));
            await Rina90DietBulkOperatorLocal1.BulkInsertBulkCopy<Genericattributetype>(lstTypes, tuple1, "[System].[Genericattributetype]", 1000);
            ...
            var Rina90DietBulkOperatorLocal2 = (IRina90DietBulkOperator)ServiceLocatorSingleton.Instance.ServiceProvider.GetService(typeof(IRina90DietBulkOperator));
            await Rina90DietBulkOperatorLocal2.BulkInsertBulkCopy<Genericattributevalue>(lstValues, tuple2, "[System].[Genericattributevalue]", 1000);
            ...
            var ix1 = 0;
            var attributeRepositoryLocal = (IRina90DietDbFullDomainRepository<Genericattribute>)ServiceLocatorSingleton.Instance.ServiceProvider.GetService(typeof(IRina90DietDbFullDomainRepository<Genericattribute>));
            ...
            var Rina90DietBulkOperatorLocal3 = (IRina90DietBulkOperator)ServiceLocatorSingleton.Instance.ServiceProvider.GetService(typeof(IRina90DietBulkOperator));
            await Rina90DietBulkOperatorLocal3.BulkInsertBulkCopy<Genericattribute>(lstAttributes, tuple3, "[System].[Genericattribute]", 1000);

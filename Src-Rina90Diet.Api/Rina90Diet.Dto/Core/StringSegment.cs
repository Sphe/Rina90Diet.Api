...
{ 
    ...
    { 
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((StringSegment)obj);
        }

        /// <summary>
        /// Returns true if StringSegment instances are equal
        /// </summary>
        /// <param name="other">Instance of StringSegment to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    if (Buffer != null)
                    hashCode = hashCode * 59 + Buffer.GetHashCode();
                    if (Offset != null)
                    ...
                    if (HasValue != null)
                    hashCode = hashCode * 59 + HasValue.GetHashCode();
                return hashCode;
            }
        }
